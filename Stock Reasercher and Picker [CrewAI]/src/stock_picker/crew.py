...
class TrendingCompany(BaseModel):
    """A company that is trending in the news"""
...
class TrendingCompanyResearch(BaseModel):
    """Detailed research report on a trending company"""
    name: str = Field(description="Company name")
    market_position: str = Field(description="Current market position and competitve analysis")
    future_outlook: str = Field(description="Future outlook for the company and growth prospects")
